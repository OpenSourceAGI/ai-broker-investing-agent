...
`worker/index.ts` calls `handleTurnstileGate` (`apps/ai-broker-web/lib/turnstile/`) before
...
[content/docs → Deployment → Turnstile first-load gate](../../apps/ai-broker-web/content/docs/deployment/turnstile-bot-gate.mdx).
