...
# the dashboard (D1 > ai-broker-db > Settings > Enable Read Replication) or with
...
#
# The Sessions API wiring in lib/db/d1-session.ts is what keeps those replica
# reads sequentially consistent. It is a no-op while replication is off and keeps
...
DATABASE_ID="37dbe79c-2687-4127-ad02-2372e15ac077"
ACTION="${1:-status}"
