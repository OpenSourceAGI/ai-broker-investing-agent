/**
 * Type definitions for the analyze-event-markets agent
 */
...
export interface ResponseMetadata {
  ...
  /** Prediction market platform (present on some error responses) */
  platform?: string;
  /** Data provider used (present on some error responses) */
  dataProvider?: DataProvider;
}
