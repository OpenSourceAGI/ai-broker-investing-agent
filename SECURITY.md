...
1. GitHub Private Vulnerability Reporting:
   https://github.com/OpenSourceAGI/ai-broker-investing-agent/security/advisories/new
...
- Unauthorized access to trading accounts, broker credentials, portfolio data, or order execution paths
...
- Broker, exchange, and market-data API credentials
